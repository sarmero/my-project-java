 ...
 * @author Sebastian
 */
public class PasoNumeroDos {

    private int matrizAux[][];
    

    public PasoNumeroDos() {

    }

    private boolean buscarMatrizb(int val, int col, int fil) {
        boolean ban = false;
...
//        System.out.println("fila = "+ fil+" col = "+ col+"  O = "+O+" P = "+P+" N = "+N+" M = "+M+" R = "+R+" Qb = "+Qb+" Qc = "+Qc+" caso = "+caso);
        //  0.0
...
//            System.out.println("fila = "+ fil+" col = "+ col+"  OO = "+OO+" PP = "+PP+" NN = "+NN+" MM = "+MM+" RC = "+Rc+" Rb = "+Rb+" Q = "+Q+" caso2 = "+caso2);
...
//        System.out.println("fila = "+ fil+" col = "+ col);
    ...
    public void ejecutarPasDos(int mat[][]) {
        matrizAux = mat;
...
//        System.out.println("valor = " + val + " fil = " + fil + " col = " + col);
